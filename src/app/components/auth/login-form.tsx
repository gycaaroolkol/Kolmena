...
export function LoginForm({ onSwitchToRegister, onGoogleLogin, onEmailLogin, onForgotPassword }: LoginFormProps) {
  ...
  const handleForgotPass = () => {
    if (!email) {
      alert("Por favor, insira seu e-mail no campo de identificação para recuperar a senha.");
      return;
    }
    if (onForgotPassword) {
    ...
    <div className="w-full space-y-8">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-end">
            <button 
              ...
              className="text-xs text-zinc-600 hover:text-[#FFA500] transition-colors"
            >
              Esqueci minha senha
            </button>
          </div>
        ...
        <div className="space-y-3 pt-4">
          <TechButton type="submit" className="h-12 text-base bg-[#ffd000]">
            Entrar
          </TechButton>
